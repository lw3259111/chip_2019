...
class FeatureBert(BertPreTrainedModel):
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None, labels=None,
                position_ids=None, head_mask=None, hand_features=None):
        outputs = self.bert(input_ids, position_ids=position_ids, token_type_ids=token_type_ids,
                            attention_mask=attention_mask, head_mask=head_mask)

        hand_features = hand_features.float()
        # features = self.features_dense(self.features_bn(hand_features))
...
def load_and_cache_examples(args, tokenizer, set_type):
    ...
    cached_features_file = os.path.join(args.data_dir, 'cached_{}_{}_{}_hand_feature'.format(
        set_type,
    ...
    dataset = TensorDataset(all_input_ids, all_input_mask, all_segment_ids, all_label_ids, all_hand_features,
